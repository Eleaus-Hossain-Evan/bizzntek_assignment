...
extension TextStyleHelpers on TextStyle {
  ...
  TextStyle colorParagraph() => copyWith(color: AppColors.textParagraph);
  TextStyle colorHint() => copyWith(color: AppColors.textHint);
  TextStyle colorSubtitle() => copyWith(color: AppColors.textSubtitle);
}
