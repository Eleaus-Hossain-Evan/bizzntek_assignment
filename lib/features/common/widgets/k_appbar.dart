...
class KAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      titleTextStyle: titleTextStyle ?? ContentTextStyle.bodyText1.bold.copyWith(color: foregroundColor),
  ...
  @override
  Size get preferredSize => Size.fromHeight(bottom == null ? kToolbarHeight : kToolbarHeight + kToolbarHeight + 16);
